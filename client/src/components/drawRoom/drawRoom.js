...
class DrawRoom extends Component {
  ...
  handleDisplayMouseMove(e) {
    ...
    this.socket.emit('cursor', {
      x: this.state.mouseX,
      y: this.state.mouseY,
      sessionKey: this.props.auth && this.props.auth.user.id
    });
    ...
    return (
      <div>
        ...
        <div className="toolbox">
          ...
          <Tool name="Eraser" currentTool={this.state.toolId} toolId="rubber" onSelect={this.handleToolClick.bind(this)} />
